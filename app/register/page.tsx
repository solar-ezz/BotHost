    ...
    <div className="min-h-screen bg-surface-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-surface-500 text-sm">Start hosting your Discord bots today</p>
        </div>
        ...
        <div className="bg-white border border-surface-200 rounded-2xl p-8 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-surface-400 mt-1.5">At least 8 characters required</p>
            </div>
            <button
              type="submit"
              disabled={loading}
